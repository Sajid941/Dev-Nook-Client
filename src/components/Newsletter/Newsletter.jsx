...
const Newsletter = () => {
    const handleNewsletter =(e)=>{
        e.preventDefault()
        e.target.reset()
        toast.success('Thank you for subscribing to our newsletter',{duration:5000})
    }
    return (
            ...
            <div className="mx-auto max-w-screen-md sm:text-center">
                ...
                <form onSubmit={handleNewsletter}>
                    <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        ...
                        <div>
                            <button  type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer  border-[#737373] sm:rounded-none sm:rounded-r-lg bg-primary-color ">Subscribe</button>
                        </div>
                    </div>
                    <div className="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300">We care about the protection of your data. <a className="font-medium text-primary-600 dark:text-primary-500 hover:underline">Read our Privacy Policy</a>.</div>
                </form>
            </div>
        </div>
      </section>
