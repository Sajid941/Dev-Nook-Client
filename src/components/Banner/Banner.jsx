...
const Banner = () => {
    ...
    return (
        <div>
            <div className="bg-wave-2 dark:bg-wave bg-no-repeat bg-cover h-fit   py-16 px-5 md:px-10 lg:px-20">
                <div className="md:grid grid-cols-2 justify-center items-center mt-10 bg-white/30 bg-opacity-20 backdrop-blur-lg p-5 rounded-xl shadow-xl">
                    <div className="px-5lg:px-20 space-y-4">
                    ...
                    <div>
                        <img className="rounded-lg mt-5 md:mt-0" src="https://i.postimg.cc/7YLnP0bY/1-LIj-LH563-Nq9esjyde3-Csv-A.jpg" alt="" />
                    </div>
                </div>
            </div>
        </div>
